...
public interface TestDAO {
	public int modifyTest1Res(Member m); //사용자의 다이어트 테스트 결과를 저장하는 메소드
	public int modifyTest2Res(Member m); //사용자의 소비성향 테스트 결과를 저장하는 메소드
	public int modifyTest3Res(Member m); //사용자의 모임성향 테스트 결과를 저장하는 메소드
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
